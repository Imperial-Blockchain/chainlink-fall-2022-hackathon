...
const BuyTokensSection = () => {
  ...
  const handleBuyVotes = () => {
    toast.promise(buyVoteTokens(amountRef.current.value), {
      pending: "Pending...",
  ...
  return (
    <div className="mx-auto my-2 flex flex-col items-center justify-center bg-gradient-to-l from-gray-600 to-gray-800 text-gray-100 p-3 max-w-md rounded-lg">
